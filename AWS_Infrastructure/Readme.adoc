...
* Post editing the config file, run the below command to restart all the IPA services. 
[,shell]
----
    ipactl stop
    ipactl start
...
* Since you would have received the CDP license before, select *Upload Cloudera Data Platform license* and upload the downloaded .txt or .zip file with the license information. 
